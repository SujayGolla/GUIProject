...
//                if (Inventory.specificItemCounter(a, s.getName()) != 0 && Inventory.specificItemCounter(a, s.getName()) < itemCounter(requirements, s.getName())){
//                    return false;
//                }
//            }
//        }
//        return true;
//    }
    public int itemCounter(ShopItemTiles[] a, String name){
        int cnt = 0;
